  ...
  const NavProfiles = () => {
    if (matchMd) {
      ...
      if (user) {
        return (
          <>
            <Profile userInfo={user} sx={{ ml: 'auto' }} handleClick={handleClick} />
          </>
        );
      }
    }
  ...
  const NavMenu = () => {
    ...
    const NavItems = user
      ? [
          ...
          <StyledMenuItem key="calendar" onClick={() => handleMenuClick('calendar')}>
            Go to Calendar
          </StyledMenuItem>,
      ...
      : [
          ...
          <StyledMenuItem key="signup" onClick={() => handleMenuClick('signup')}>
            Sign Up
          </StyledMenuItem>,
        ];
    return (
        ...
        <Toolbar>
          {
            ...
            matchMd ? (
              <>
                ...
                <NavbarButton key="about" onClick={() => handleMenuClick('about')}>
              ...
              <>
                ...
                <NavMenu />
                <Link href="/" variant="h5" color="inherit" underline="none" sx={{ ml: 'auto' }}>
                  MyCalendar
                </Link>
                <NavProfiles />
              </>
